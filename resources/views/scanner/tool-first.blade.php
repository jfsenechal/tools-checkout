...
<div x-show="mode === 'tool-first' && !scannedTool" class="bg-white rounded-lg shadow-lg p-6 mb-6">
    <h2 class="text-xl font-semibold mb-4 text-gray-800">Scanner le code QR de l'outil</h2>
    ...
    <div x-show="scanning && cameraActive && !qrDetected" class="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
        <p class="text-blue-800 text-center">Recherche du code QR...</p>
    </div>
...
<div x-show="mode === 'tool-first' && scannedTool" x-cloak class="bg-white rounded-lg shadow-lg p-6 mb-6">
    <div class="flex justify-between items-start mb-4">
        <h2 class="text-xl font-semibold text-gray-800">Informations sur l'outil</h2>
    ...
    <div class="space-y-3">
        <div>
            <span class="text-sm text-gray-500">Nom de l'outil</span>
        ...
        <template x-if="currentCheckout">
            <div class="mt-4 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                <p class="font-semibold text-yellow-900 mb-2">Actuellement prêté à :</p>
                <p class="text-yellow-800" x-text="currentCheckout.worker.first_name + ' ' + currentCheckout.worker.last_name"></p>
                <p class="text-sm text-yellow-600">Depuis : <span x-text="formatDate(currentCheckout.checked_out_at)"></span></p>
                <span
    ...
    <div class="bg-white rounded-lg shadow-xl max-w-md w-full max-h-[80vh] overflow-hidden">
        <div class="p-6 border-b">
            <div class="flex justify-between items-center mb-4">
                <h3 class="text-lg font-semibold">Sélectionner un ouvrier</h3>
        ...
        <div class="overflow-y-auto max-h-96 p-4">
            ...
            <template x-if="!loadingWorkers && workers.length === 0">
                <p class="text-center text-gray-500 py-8">Aucun ouvrier trouvé</p>
            </template>
